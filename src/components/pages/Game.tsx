    ...
    return (
        <div className={styles.gameField}>
            ...
            <div className={styles.feedback}>
                <div className={activeArrow === 'ArrowLeft' ? `${styles.leftArrow} ${styles.activeArrow}` : styles.leftArrow}>
                ...
                <div className={activeArrow === 'ArrowRight' ? `${styles.rightArrow} ${styles.activeArrow}` : styles.rightArrow}>
